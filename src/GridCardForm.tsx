                ...
                {isExtraSmall ? <>(
                    ...
                    isSmScreen ? (
                            <>
                                ...
                                <Grid item sx={{flexGrow: 1}}>
                                    <GridCard2 title="2nd row" content="Smartphone" number={2}/>
                                </Grid>
                            </>
                        ) :
                        ...
                        isMdScreen ? (
                            ...
                            <>
                                <Grid item sx={{flexGrow: 1}}>
                                    <GridCard2 title="2nd row" content="Desktop" number={1}/>
                                </Grid>
                                <Grid item sx={{flexGrow: 1}}>
                                    <GridCard2 title="2nd row" content="Desktop" number={2}/>
                                </Grid>
                                <Grid item sx={{flexGrow: 1}}>
                                    <GridCard2 title="2nd row" content="Desktop" number={3}/>
                                </Grid>
                                <Grid item sx={{flexGrow: 1}}>
